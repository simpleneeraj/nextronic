...
const data: CircleChartProps[] = [
  {
    ...
    total: 1358,
    chartData: [
      { name: 'Active Users', value: 780, fill: 'hsl(var(--nextui-primary))' },
    ],
  },
  {
    title: 'Revenue',
    ...
    total: 2450,
    chartData: [
      { name: 'Monthly', value: 1840, fill: 'hsl(var(--nextui-primary))' },
    ],
  },
  {
    title: 'Engagement',
  ...
  },
  {
    ...
    total: 1000,
    chartData: [
      { name: 'Sales', value: 750, fill: 'hsl(var(--nextui-success))' },
    ],
  },
  {
    title: 'Bounce Rate',
    ...
    total: 100,
    chartData: [
      { name: 'Exits', value: 80, fill: 'hsl(var(--nextui-warning))' },
    ],
  },
  {
    title: 'Errors',
    ...
    total: 500,
    chartData: [
      { name: 'Issues', value: 450, fill: 'hsl(var(--nextui-danger))' },
    ],
  },
];

export default function MiniCircles() {
  return (
    <dl className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {data.map((item, index) => (
        <Circles key={index} {...item} />
      ))}
    </dl>
  );
}
...
const Circles = React.forwardRef<
  HTMLDivElement,
...
Circles.displayName = 'CircleChartCard';
